...
void yyerror(const char * message){
    fprintf(stderr, "Error: %s en la línea: %d", message, yylineno);
}
%}
...
%token KW_STRING KW_ARRAY KW_FUN KW_WHILE TK_LEFTKEY TK_RIGHTKEY TK_CHAR TK_COMMENT_LINE TK_LIT_STRING
...
statement: KW_VAR TK_ID ':' type '=' expression
         | KW_VAR TK_ID ':' type
         ...
         | TK_ID '=' expression
         | TK_ID TK_LEFTPARENS expression TK_RIGHTPARENS
         | KW_FOR TK_LEFTPARENS expression TK_RIGHTPARENS TK_LEFTKEY statement_list TK_RIGHTKEY
         | KW_WHILE TK_LEFTPARENS expression TK_RIGHTPARENS TK_LEFTKEY statement_list  TK_RIGHTKEY
         | KW_DO TK_LEFTKEY statement_list TK_RIGHTKEY KW_WHILE TK_LEFTPARENS expression TK_RIGHTPARENS
         | KW_IF TK_LEFTPARENS expression TK_RIGHTPARENS TK_LEFTKEY statement_list TK_RIGHTKEY
         | KW_IF TK_LEFTPARENS expression TK_RIGHTPARENS TK_LEFTKEY statement_list TK_RIGHTKEY KW_ELSE TK_LEFTKEY statement_list TK_RIGHTKEY
         | expression
         ;
